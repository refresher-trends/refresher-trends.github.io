...
sed -i 's/{% response 'body', 'req_8cbcef67dafb44e9ae6d6e4e5cce7d68', 'b64::JC50b2tlbg==::46b', 'never', 60 %}/NJLGNILKJZBUlK4kYpEF59H5is0zLv8YRpR2R1s0eGap9feqFXwUPD9WGRco/g' docs/insomnia.json
